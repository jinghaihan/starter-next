    ...
    <>
      <header>
        <nav
          ...
          className="
            fixed z-20 w-full border-b border-dashed bg-white backdrop-blur-sm
            md:relative
            dark:bg-zinc-950/50
        ...
        >
          <div className="m-auto max-w-5xl px-6">
            <div className="
              flex flex-wrap items-center justify-between gap-6 py-3
              lg:gap-0 lg:py-4
            "
            >
              <div className="
              ...
              >
                ...
                >
                  ...
                  />
                  <X className="
                    absolute inset-0 m-auto size-6 scale-0 -rotate-180 opacity-0
                    duration-200
              ...
              >
                <div className="lg:pr-4">
                  <ul className="
                    space-y-6 text-base
                    lg:flex lg:gap-8 lg:space-y-0 lg:text-sm
                  "
                  >
                    {menuItems.map(item => (
                      <li key={item.name}>
      ...
      <main>
        <div
          aria-hidden
          className="
            absolute inset-0 isolate z-2 hidden opacity-50 contain-strict
            lg:block
          "
        >
          <div className="
            absolute top-0 left-0 h-320 w-140 -translate-y-87.5 -rotate-45
            rounded-full
            bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,hsla(0,0%,85%,.08)_0,hsla(0,0%,55%,.02)_50%,hsla(0,0%,45%,0)_80%)]
          "
          />
          <div className="
            absolute top-0 left-0 h-320 w-60 [translate:5%_-50%] -rotate-45
            rounded-full
            bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,85%,.06)_0,hsla(0,0%,45%,.02)_80%,transparent_100%)]
          "
          />
          <div className="
            absolute top-0 left-0 h-320 w-60 -translate-y-87.5 -rotate-45
        ...
        >
          <div className="
            relative mx-auto max-w-5xl px-6 pt-28
            lg:pt-24
          "
          >
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              ...
              <p className="
                mx-auto my-8 max-w-2xl text-xl text-muted-foreground
              "
              >
          ...
          >
            <div className="
              pl-8 perspective-distant
              lg:pl-44
            "
            >
              <div className="
                rotate-x-20 skew-x-12 mask-r-from-75% mask-b-from-55%
                mask-b-to-100% pt-6 pl-6
                lg:h-176
              "
              >
                <Image
                  className="
                    rounded-(--radius) border shadow-xl
                    dark:hidden
                  "
                  src="/card.png"
                ...
                <Image
                  className="
                    hidden rounded-(--radius) border shadow-xl
                    dark:block
                  "
                  src="/dark-card.webp"
                  alt="Tailark hero section"
        ...
        <section className="
          relative z-10 bg-muted/50 py-16
          dark:bg-background
        "
        >
          <div className="m-auto max-w-5xl px-6">
            ...
            <div className="
              mx-auto mt-20 flex max-w-4xl flex-wrap items-center justify-center
              gap-x-12 gap-y-8
              **:fill-foreground
              sm:gap-x-16 sm:gap-y-12
            "
            >
              <Bolt
                height={22}
